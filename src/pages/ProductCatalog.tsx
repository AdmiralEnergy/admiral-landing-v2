...
const ProductCatalog = () => {
  ...
  const PanelCard = ({ panel }: any) => (
    <div 
      onClick={() => setSelectedProduct(panel)}
      style={{
    ...
    >
      ...
      <div style={{ color: BRAND.gold, fontSize: '13px', fontWeight: 'bold', marginBottom: '4px', letterSpacing: '0.05em' }}>
        {panel.manufacturer}
      </div>
      <h3 style={{ color: BRAND.navy, fontSize: '18px', fontWeight: 'bold', marginBottom: '12px', lineHeight: '1.3' }}>
        {panel.model}
      </h3>
      ...
      <div style={{
        ...
        <span style={{ color: '#065f46', fontWeight: 'bold', fontSize: '14px' }}>{panel.savings}</span>
      </div>
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: '11px', color: '#6b7280', marginBottom: '4px', fontWeight: '600' }}>POWER</div>
          <div style={{ fontSize: '22px', fontWeight: 'bold', color: BRAND.navy }}>{panel.watts}W</div>
        </div>
        <div>
          <div style={{ fontSize: '11px', color: '#6b7280', marginBottom: '4px', fontWeight: '600' }}>EFFICIENCY</div>
          <div style={{ fontSize: '22px', fontWeight: 'bold', color: '#10b981' }}>{panel.efficiency}%</div>
        </div>
        <div>
          <div style={{ fontSize: '11px', color: '#6b7280', marginBottom: '4px', fontWeight: '600' }}>WARRANTY</div>
          <div style={{ fontSize: '16px', fontWeight: 'bold', color: BRAND.navy }}>{panel.warranty} yrs</div>
        </div>
        <div>
          <div style={{ fontSize: '11px', color: '#6b7280', marginBottom: '4px', fontWeight: '600' }}>PRICE</div>
          <div style={{ fontSize: '16px', fontWeight: 'bold', color: BRAND.gold }}>${panel.cost}</div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
          <Star size={18} style={{ color: '#1e40af', flexShrink: 0, marginTop: '2px' }} />
          <p style={{ fontSize: '13px', color: '#1e40af', fontWeight: 'bold', lineHeight: '1.4', margin: 0 }}>
            {panel.whyBuy}
          </p>
        </div>
      </div>
  ...
  const BatteryCard = ({ battery }: any) => (
    <div 
      onClick={() => setSelectedProduct(battery)}
      style={{
        background: BRAND.cream,
        border: `3px solid ${BRAND.creamDark}`,
        borderRadius: '16px',
    ...
    >
      ...
      <div style={{
        ...
        <span style={{ color: '#6b21a8', fontWeight: 'bold', fontSize: '14px' }}>
          Powers home {battery.backupTime}
        </span>
      </div>

      {/* PowerPair Rebate Callout */}
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
          <Award size={18} style={{ color: '#fef3c7' }} />
          <span style={{ color: '#fef3c7', fontSize: '12px', fontWeight: 'bold' }}>
            DUKE POWERPAIR REBATE
          </span>
        </div>
        <div style={{ color: '#fef3c7', fontSize: '22px', fontWeight: 'bold' }}>
          ${battery.powerPairRebate.toLocaleString()} Back
        </div>
        {battery.powerPairNote && (
          <div style={{ color: '#fef3c7', fontSize: '11px', fontWeight: '600', marginTop: '4px' }}>
            {battery.powerPairNote}
          </div>
        )}
      </div>
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: '11px', color: '#6b7280', marginBottom: '4px', fontWeight: '600' }}>CAPACITY</div>
          <div style={{ fontSize: '22px', fontWeight: 'bold', color: BRAND.navy }}>{battery.capacity} kWh</div>
        </div>
        <div>
          <div style={{ fontSize: '11px', color: '#6b7280', marginBottom: '4px', fontWeight: '600' }}>POWER</div>
          <div style={{ fontSize: '22px', fontWeight: 'bold', color: '#10b981' }}>{battery.power} kW</div>
        </div>
        <div>
          <div style={{ fontSize: '11px', color: '#6b7280', marginBottom: '4px', fontWeight: '600' }}>WARRANTY</div>
          <div style={{ fontSize: '16px', fontWeight: 'bold', color: BRAND.navy }}>{battery.warranty} yrs</div>
        </div>
        <div>
          <div style={{ fontSize: '11px', color: '#6b7280', marginBottom: '4px', fontWeight: '600' }}>PRICE</div>
          <div style={{ fontSize: '16px', fontWeight: 'bold', color: BRAND.gold }}>${(battery.cost/1000).toFixed(1)}k</div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <Shield size={18} style={{ color: '#065f46' }} />
        <span style={{ fontSize: '13px', color: '#065f46', fontWeight: 'bold' }}>LFP - Safest Chemistry</span>
      </div>
  ...
  const DetailModal = ({ product, onClose }: any) => {
      ...
      >
        ...
        >
          ...
          <div style={{ marginBottom: '32px' }}>
            <div style={{ color: BRAND.gold, fontSize: '14px', fontWeight: 'bold', marginBottom: '8px', letterSpacing: '0.05em' }}>
              {product.manufacturer}
            </div>
            <h2 style={{ color: BRAND.navy, fontSize: '36px', fontWeight: 'bold', marginBottom: '16px', lineHeight: '1.2' }}>
              {product.model}
            </h2>
            <div style={{ fontSize: '32px', fontWeight: 'bold', color: BRAND.gold }}>
              ${isPanel ? product.cost : (product.cost/1000).toFixed(1) + 'k'}
            </div>
          </div>
          ...
          <div style={{
            ...
            <h3 style={{ color: '#1e40af', fontSize: '20px', fontWeight: 'bold', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
              <Star size={24} />
              Why Choose This?
            </h3>
            <p style={{ color: '#1e40af', fontSize: '18px', fontWeight: 'bold', lineHeight: '1.6', margin: 0 }}>
              {isPanel ? product.whyBuy : product.whyBuy}
            </p>
          </div>

          <div style={{ marginBottom: '32px' }}>
            <h3 style={{ color: BRAND.navy, fontSize: '24px', fontWeight: 'bold', marginBottom: '16px' }}>
              Key Benefits
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {product.features.map((feature: any, idx: any) => (
                ...
                >
                  <CheckCircle size={24} style={{ color: '#065f46', flexShrink: 0, marginTop: '2px' }} />
                  <span style={{ color: '#065f46', fontSize: '15px', fontWeight: '600', lineHeight: '1.5' }}>
                    {feature}
                  </span>
                </div>
              ))}
          ...
          <div style={{
            ...
            <h4 style={{ color: BRAND.navy, fontSize: '20px', fontWeight: 'bold', marginBottom: '12px' }}>
              Perfect For:
            </h4>
            <p style={{ color: BRAND.navy, fontSize: '18px', fontWeight: 'bold', lineHeight: '1.6', margin: 0 }}>
              {product.bestFor}
            </p>
          </div>
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          <div style={{
            ...
            CERTIFIED DUKE ENERGY TRADE ALLY
          </div>
          ...
          <h2 style={{ color: BRAND.cream, fontSize: '36px', fontWeight: 'bold', marginBottom: '16px' }}>
            Premium Solar & Battery Systems
          </h2>
          
          <p style={{ color: BRAND.cream, fontSize: '20px', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Stop renting power from Duke Energy. Own your energy independence with America's top-rated equipment.
          </p>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ borderRight: '2px solid #78350f', paddingRight: '16px' }}>
              ...
              <div style={{ color: '#78350f', fontSize: '14px', fontWeight: '600' }}>
                Capacity filling - first come, first served
              </div>
            </div>
            <div style={{ borderRight: '2px solid #78350f', paddingRight: '16px' }}>
              <div style={{ color: '#dc2626', fontSize: '13px', fontWeight: 'bold', marginBottom: '4px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '24px', marginBottom: '48px' }}>
          ...
          >
            <Sun size={28} />
            Solar Panels ({SOLAR_PANELS.length})
          </button>
          ...
          >
            <Battery size={28} />
            Battery Systems ({BATTERIES.length})
          </button>
        </div>
        ...
        <div style={{
          ...
          <h3 style={{ color: BRAND.navy, fontSize: '32px', fontWeight: 'bold', marginBottom: '16px' }}>
